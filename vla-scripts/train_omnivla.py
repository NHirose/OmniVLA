...
def visualize_train(
    ...
    for i in range(num_images_log):
        ...
        ax_graph.plot(-np.insert(y_est, 0, 0.0), np.insert(x_est, 0, 0.0), linewidth=4.0, markersize=12, marker='o', color='blue')                                                      
...
def train_omnivla(cfg: OmniVLAConfig) -> None:
    ...
    #checkpoint_path_mbra = os.path.join("./MBRA_BDD", "mbra_bdd.pth")
